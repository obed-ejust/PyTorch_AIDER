...
class ACFFModel(nn.Module):
    def __init__(self, num_classes):
        ...
        self.block1 = AtrousBlock(32, 8, 32, kernel_size=3, stride=1, act='l', dropout_rate=None, fusion_type='add')
        self.pool1 = nn.MaxPool2d(kernel_size=2, stride=2)
        self.block2 = AtrousBlock(32, 4, 16, kernel_size=3, stride=1, act='l', dropout_rate=None, fusion_type='add')
        self.pool2 = nn.MaxPool2d(kernel_size=2, stride=2)
        self.block3 = AtrousBlock(16, 4, 16, kernel_size=3, stride=1, act='l', dropout_rate=None, fusion_type='add')
        self.pool3 = nn.MaxPool2d(kernel_size=2, stride=2)
        self.block4 = AtrousBlock(16, 4, 16, kernel_size=3, stride=1, act='l', dropout_rate=None, fusion_type='add')
        # self.pool4 = nn.MaxPool2d(kernel_size=2, stride=2)
        # self.block5 = AtrousBlock(16, 4, 16, kernel_size=3, stride=1, act='l', dropout_rate=None, fusion_type='add')
        # self.block6 = AtrousBlock(16, 4, 16, kernel_size=3, stride=1, act='l', dropout_rate=None, fusion_type='add')
        # self.block7 = AtrousBlock(128, 256, kernel_size=3, stride=1, act='l', dropout_rate=None, fusion_type='add')
        self.sepconv = SeparableConvBlock(16, num_classes, kernel_size=1, stride=1, dropout_rate=None, act='l')
